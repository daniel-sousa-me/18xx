  ...
  module Game
    class Spreadsheet < Snabberb::Component
      ...
      def render_titles
        ...
        bottom.concat(connection_run_subheader)
        ...
        result.sort_by! do |corporation, order|
          main = case @spreadsheet_sort_by
                 ...
                 when :companies
                   ...
                   n.nil? || n.zero? ? -Float::INFINITY : n # sort shorts between longs and 0 shares
                 end
          [main, corporation]
        end
      ...
      def render_corporation(corporation, order, _index)
        ...
        children << h('td.padded_number',
                      corporation.minor? ? '' : (corporation.num_ipo_reserved_shares + num_shares_of(corporation, corporation)).to_s) unless @hide_reserved
        children << h('td.padded_number',
        ...
        children << h(:td, @game.token_string(corporation))
        ...
        children << h(:td, @game.corporation_size_name(corporation)) if @diff_corp_sizes

        children << render_companies(corporation)
        children.concat(render_connection_run(corporation))
