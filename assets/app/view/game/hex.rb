  ...
  module Game
    class Hex < Snabberb::Component
      ...
      def render
        ...
        @changed_hex = @game.round.changed_hexes.any?(@hex) if @game
        @tile =
        ...
        props[:attrs]['stroke-dasharray'] = '10, 5' if !@selected && @changed_hex
        props[:attrs]['stroke-width'] = 5 if @selected || @changed_hex
        h(:g, props, children)
      end
